            ...
            <div>
                ...
                <footer className="container-fluid d-none d-md-block footer-dark">
                    <div className="row d-flex">
                        <Link to='/' className="col mb-4 mt-4 text-white text-center nav-link" >Home</Link>
                        <Link to='/encontreProfissionais' className="col mb-4 mt-4 text-white text-center nav-link" >Encontre
                            Profissionais</Link>
                        <Link to='/divulgueSeuTrabalho' className="col mb-4 mt-4 text-white text-center nav-link" >Divulgue seu
                            Trabalho</Link>
                        <Link to='/quemSomos' className="col mb-4 mt-4 text-white text-center nav-link" >Quem Somos</Link>
                        <Link to='/contato' className="col mb-4 mt-4 text-white text-center nav-link" >Contato</Link>
                        <Link to='/entrar' className="col mb-4 mt-4 text-white text-center nav-link" >Entrar</Link>
                        <Link to='/cadastro' className="col mb-4 mt-4 text-white text-center nav-link" >Cadastro</Link>
                    </div>
